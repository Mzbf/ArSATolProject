...
import { IMethodeLutte, MethodeLutte } from 'app/shared/model/methode-lutte.model';

describe('Service Tests', () => {
    describe('MethodeLutte Service', () => {
        let injector: TestBed;
        let service: MethodeLutteService;
        let httpMock: HttpTestingController;
        let elemDefault: IMethodeLutte;
        beforeEach(() => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a MethodeLutte', async () => {
            ...
            it('should delete a MethodeLutte', async () => {
